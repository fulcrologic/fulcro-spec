...
Current Production: [fulcrologic/fulcro-spec "1.0.0"]

Upcoming 2.x version: image:https://img.shields.io/clojars/v/fulcrologic/fulcro-spec.svg[link="https://clojars.org/fulcrologic/fulcro-spec"]
