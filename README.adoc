...
image::https://img.shields.io/clojars/v/awkay/untangled-spec.svg[link="https://clojars.org/awkay/untangled-spec"]

Release: image:https://api.travis-ci.org/awkay/untangled-spec.svg?branch=master[link=https://github.com/awkay/untangled-spec/tree/master]
Develop: image:https://api.travis-ci.org/awkay/untangled-spec.svg?branch=develop[link=https://github.com/awkay/untangled-spec/tree/develop]
...
* Add `[awkay/untangled-spec "x.y.z"]` to your `:dependencies`.
