...
- https://github.com/untangled-web/untangled-spec/blob/feature/documentation/test/untangled_spec/all_tests.cljs[all_tests.cljs] : An entry point for CI testing from the command line.
- https://github.com/untangled-web/untangled-spec/blob/feature/documentation/dev/cljs/user.cljs[user.cljs] : The entry point for browser test rendering.
- https://github.com/untangled-web/untangled-spec/blob/feature/documentation/test/untangled_spec/tests_to_run.cljs[tests_to_run.cljs] : A file that does nothing more than require all of the specs. The test runners search for
...
There is a top level https://github.com/untangled-web/untangled-spec/blob/feature/documentation/package.json[package.json] file for installing node packages to run CI tests.

The https://github.com/untangled-web/untangled-spec/blob/feature/documentation/project.clj[project.clj] includes various things to make all of this work:
...
- A cljsbuild for testing with figwheel true. The build with id "test" https://github.com/untangled-web/untangled-spec/blob/feature/documentation/project.clj#L36[here], is the browser test build.
- A cljsbuild for testing with lein doo. The build with id "automated-tests" https://github.com/untangled-web/untangled-spec/blob/feature/documentation/project.clj#L47[here], is the CI tests output.
